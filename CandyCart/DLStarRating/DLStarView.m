...
- (void)centerIn:(CGRect)_frame with:(int)numberOfStars starGapAdjust:(float)starGap {
	...
	self.frame = CGRectMake((size.width*self.tag) *starGap, newY, size.width, size.height);
}
