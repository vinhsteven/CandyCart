//Background Image
@BACKGROUND_IMAGE: NUIViewBackground.png;
...
//PRIMARY APP COLOR
@PRIMARYCOLOR:#da251c; //Effect Navigation Bar & Button Color & TableViewSelected //saigon cafeda
@PRIMARYCOLOR_BOLD:#ac0d05; //E.g On selected segment
...
NavigationBar {
background-tint-color:@OTHER_COLOR;
  background-color:@PRIMARYCOLOR;
    font-name: @PRIMARYFONT;
    font-size: 22;
    font-color: #FFFFFF;
...
TabBar {
    //background-color: #000000;
    font-name: @PRIMARYFONT;
   background-tint-color:@PRIMARYCOLOR;
